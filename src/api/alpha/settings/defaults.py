...
while os.path.basename(root_path).lower() != 'api':
...
MIDDLEWARE_CLASSES = [
    ...
    'user.middleware.SessionHeaderMiddleWare',
    ...
    'backstage.auth.middleware.PubAuthMiddleWare',
    'backstage.auth.middleware.DisableCSRFCheckMiddleWare',
]
